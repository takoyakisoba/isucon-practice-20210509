...
CREATE INDEX idx_items_status_category_id_created_at ON items (status, category_id, created_at);
CREATE INDEX idx_items_seller_id_status ON items (status, seller_id);
